...
Questo sito raccoglie i seguenti dati personali solo quando forniti volontariamente dall'utente attraverso il modulo di contatto:
...
- Fornire preventivi per i servizi richiesti
- Comunicazioni relative ai servizi offerti

### Base Giuridica

Il trattamento dei dati si basa sul consenso dell'interessato, espresso al momento dell'invio del modulo di contatto.

### Conservazione dei Dati

I dati personali saranno conservati per il tempo necessario a evadere la richiesta e comunque non oltre 24 mesi dalla raccolta, salvo obblighi di legge.
...
Ci riserviamo il diritto di modificare questa informativa. La data di ultimo aggiornamento è indicata all'inizio del documento.
